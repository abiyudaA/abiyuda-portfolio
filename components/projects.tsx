  ...
  const projects = [
    {
      ...
      title: "CRAND",
      description:
        "CRAND is a web app for pesantren / school database management, the main features are: 1. weekly report pdf sender 2. Face recognition attendance for employees",
    ...
    },
    {
      ...
      github: "https://github.com/abiyuda/zalola",
    ...
    },
    {
      ...
      github: "https://github.com/abiyuda/youcube",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-700 dark:text-gray-300 text-lg max-w-2xl mx-auto mb-8">
            Here are some of the projects I've worked on. Each one represents different skills and technologies I've
            mastered.
          </p>
